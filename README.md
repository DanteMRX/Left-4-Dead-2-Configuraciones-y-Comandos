# Opciones de Lanzamiento del Juego (esto va en los parametros del juegos)

-high -nosync -nomsaa -noaafonts -lv -nojoy -novid -console -freq (Hz de tu monitor)
-useallavailablecores -nod3d9ex -dxlevel 81 -threads (Núcleos de tu procesador)
